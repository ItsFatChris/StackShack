...
public class ManagerLevel3 : MonoBehaviour {
    ...
    public GameObject showOnion;
    public GameObject showBacon;
    ...
    void spawn()
    {
        ...
        switch (count)
        {
            ...
            case 5:
                ...
                Destroy(showLett);
                showBacon = Instantiate(showBacon);
                count++;
                break;
            ...
            case 6:
                ...
                Destroy(arrow);
                arrow = Instantiate(arrow, Spawn[rand].position, arrow.transform.rotation);
                Bacon = Instantiate(Bacon, Spawn[rand].position, Spawn[rand].rotation);

                Destroy(showBacon);
                showOnion = Instantiate(showOnion);
                //spawn bacon
            ...
            case 7:
                if (Bacon)
                { Bacon.GetComponent<Rigidbody2D>().Sleep(); }
                Destroy(arrow);
                arrow = Instantiate(arrow, Spawn[rand].position, arrow.transform.rotation);
                Onion = Instantiate(Onion, Spawn[rand].position, Spawn[rand].rotation);
            ...
            case 8:
                ...
                //Tomato.GetComponent<Rigidbody2D>().constraints = RigidbodyConstraints2D.FreezeRotation;
                if (Onion)
                { Onion.GetComponent<Rigidbody2D>().Sleep(); }
                Destroy(arrow);
                arrow = Instantiate(arrow, Spawn[rand].position, arrow.transform.rotation);
